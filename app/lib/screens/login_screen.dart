        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                Text('Chào mừng đến với', style: TextStyle(fontFamily: 'Montserrat', fontSize: 28, fontWeight: FontWeight.w500, color: Color(0xFF388E3C))),
                SizedBox(height: 8),
                Text('ecoPoint', style: TextStyle(fontFamily: 'Montserrat', fontSize: 48, fontWeight: FontWeight.bold, color: Color(0xFF388E3C))),
                SizedBox(height: 12),
                Text('Tái chế vật liệu thải của bạn một cách thông minh', style: TextStyle(fontFamily: 'Montserrat', fontSize: 16, fontWeight: FontWeight.w400, color: Color(0xFF388E3C).withOpacity(0.8))),
